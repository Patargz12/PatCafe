            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Patrick Cafe is one of the best restaurant in the Philippines
                            with Greenwich Vibes. For more info pleaese make a reservation with us or order on our
                            website. Message us for more Inquiries.</p>
                        <div class="row">
                            <div class="col-4">
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Patrick Cafe

                            <br>Developed By: Patrick Arganza
                        </p>
                    </div>
                </div>
            </div>
